  ...
  void _seedDemo() {
    ...
    _store.addAll([
      Certificate(
        ...
        latitude: 48.8566,
        longitude: 2.3522,
        locationLabel: '10 Rue de Rivoli, Paris, Île-de-France, France',
        city: 'Paris',
        country: 'France',
      ...
      Certificate(
        ...
        latitude: 45.7640,
        longitude: 4.8357,
        locationLabel: '5 Place Bellecour, Lyon, Auvergne-Rhône-Alpes, France',
        city: 'Lyon',
        country: 'France',
        status: CertificateStatus.certified,
      ...
      Certificate(
        ...
        latitude: 43.2965,
        longitude: 5.3698,
        locationLabel: '1 La Canebière, Marseille, Provence-Alpes, France',
        city: 'Marseille',
        country: 'France',
        status: CertificateStatus.certified,
